 ...
 * guest, if the host interface is supported.  If @name is omitted,
 ...
 * VIR_DOMAIN_CHANNEL_FORCE will cause libvirt to forcefully remove
 * the other client prior to opening this channel.
 *
